...
... TO DO ...
1. B-Tree and Bitmap
2. Partitioned Indexes LOCAL/GLOBAl
================================================================================
...
/*
Now we add a UNIQUE constraint ti the same column
*/
...
impact of various indexes much quicker. Remember, there is an impact on DML 
performance of having too many indexes on a table, so this should be a short 
term situation.


WHEN TO DREATE MULTIPLE INDEXES ON THE SAME SET OF COLUMNS
...
This indicates that the first two sales were in LONDON, he third in OXFORD,
